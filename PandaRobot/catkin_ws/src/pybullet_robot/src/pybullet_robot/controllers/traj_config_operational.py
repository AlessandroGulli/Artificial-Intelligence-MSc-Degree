...
trajectory = np.array([[init_pos[0], init_pos[1], init_pos[2], init_ori[0], init_ori[1], init_ori[2]], 
			...
			[init_pos[0], init_pos[1], 0.45       , -np.pi/2   , init_ori[1], init_ori[2]], 
			[init_pos[0], init_pos[1], init_pos[2], -np.pi/3   , -np.pi/5   , init_ori[2]], 
			[init_pos[0], init_pos[1], init_pos[2], init_ori[0], init_ori[1], init_ori[2]], 
			[0.2        , -0.20      , 0.45       , init_ori[0], init_ori[1], np.pi/3    ]
		      ])
		      
T = np.array([1.,1.2,1.2,1.2, 2.])
grip_cmd = np.array([[-1,0.025,0],[0,0,0],[1,0.04,0],[0,0,0],[-1,0,0]])
rate = 240. #Hz
