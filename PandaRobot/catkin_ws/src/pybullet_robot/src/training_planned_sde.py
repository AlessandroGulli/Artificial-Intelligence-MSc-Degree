...
if __name__ == '__main__':
    ...
    model = PPO("MlpPolicy", env, batch_size=128, n_steps=512, n_epochs=20, gae_lambda=0.9, clip_range=0.4, use_sde=True, sde_sample_freq=4, policy_kwargs=policy_kwargs, verbose=3, tensorboard_log="./RL/panda_PPO_tensorboard/").learn(int(1e15), callback=callback, tb_log_name="telemetry")    
